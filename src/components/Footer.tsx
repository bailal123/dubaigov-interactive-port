...
const Footer = () => {
  ...
  const sections = [
    ...
    {
      title: "قطاع الأراضي",
      links: ["إدارة التخطيط العقاري", "إدارة مسح الأراضي", "إدارة الأراضي الحكومية"],
    },
    {
      title: "قطاع التطوير العقاري",
      links: ["إدارة التنظيم العقاري", "إدارة التراخيص العقارية", "إدارة العلاقات العامة"],
    },
    {
      title: "قطاع الخدمات المؤسسية",
      links: ["إدارة تقنية المعلومات", "إدارة الخدمات المؤسسية", "مركز الاتصال"],
    },
    {
      title: "قطاع التخطيط والتطوير",
      links: ["إدارة التخطيط الاستراتيجي", "إدارة المشاريع", "إدارة الأداء المؤسسي"],
    },
  ];
